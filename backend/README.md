...
## Project Structure
    ...
    ├── testapiautosetting_127311  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127311`
...
2. Clone this repo and `cd testapiautosetting_127311`
